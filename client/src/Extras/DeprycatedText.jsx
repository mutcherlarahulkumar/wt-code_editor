...
export default function DecryptedText({
  ...
  className = 'text-5xl font-bold p-2 text-blue-300',
  parentClassName = '',
  encryptedClassName = '',
  animateOn = 'hover',
  ...props
  ...
  return (
    <motion.span
      ref={containerRef}
      className={`inline-block whitespace-pre-wrap relative ${parentClassName}text-5xl font-bold p-6 text-blue-300`}
      {...hoverProps}
      {...props}
    >
